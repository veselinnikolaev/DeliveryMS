    ...
    <div class="container">
        ...
        <div class="order-details">
            ...
            <div class="order-details-row">
                ...
                <span class="order-details-value"><?php echo date('m/d/Y', $tpl['order']['created_at']); ?></span>
            </div>

            <?php if (!empty($tpl['order_products'])): ?>
                <div class="order-details-row">
                    <span class="order-details-label">Items:</span>
                    <span class="order-details-value"><?php echo count($tpl['order_products']); ?></span>
                </div>
            <?php endif; ?>
            ...
            <div class="order-details-row">
                ...
                <span
                    class="order-details-value"><?php echo Utility::getDisplayableAmount($tpl['order']['product_price']); ?></span>
            </div>

            <div class="order-details-row">
                <span class="order-details-label">Tax:</span>
                <span
                    class="order-details-value"><?php echo Utility::getDisplayableAmount($tpl['order']['tax']); ?></span>
            </div>

            <div class="order-details-row">
                <span class="order-details-label">Shipping:</span>
                <span
                    class="order-details-value"><?php echo Utility::getDisplayableAmount($tpl['order']['shipping_price']); ?></span>
            </div>

            <div class="order-details-row">
                <span class="order-details-label">Total Amount:</span>
                <span
                    class="order-details-value total-amount"><?php echo Utility::getDisplayableAmount($tpl['order']['total_amount']); ?></span>
            </div>
        </div>
        ...
        <div class="payment-methods">
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                ...
                <input type="hidden" name="item_number" value="<?php echo $tpl['order']['id']; ?>">
                <input type="hidden" name="amount" value="<?php echo $tpl['order']['total_amount']; ?>">
                <input type="hidden" name="currency_code" value="<?php echo $tpl['currency_code']; ?>">
