        ...
        <div class="col-sm-12">
            <div class="">
                ...
                <div class="card card-rounded mt-3">
                    <div class="card-body">
                        <div class="table-responsive" id="container-curier-id">
                            <?php
...
<div class="modal fade" id="deleteCurier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-id="" id="delete-btn-curier-id">Delete</button>
