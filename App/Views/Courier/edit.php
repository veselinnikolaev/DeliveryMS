                    ...
                    <form class="forms-sample" method="POST" action="<?php echo INSTALL_URL; ?>?controller=Courier&action=edit">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="contactNumber" name="phone_number" value="<?php echo $tpl['phone_number'] ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary me-2">Edit Courier</button>
