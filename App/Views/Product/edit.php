                    ...
                    <form class="forms-sample" method="POST" action="<?php echo INSTALL_URL . "?controller=Product&action=edit"; ?>">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="price" name="price" value="<?php echo $tpl['price'] ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                <label for="stock" class="form-label">Stock</label>
                                <input type="text" class="form-control" id="stock" name="stock" value="<?php echo $tpl['stock'] ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
