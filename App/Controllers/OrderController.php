...
class OrderController extends Controller {
                ...
                if ($orderId) {
                    ...
                    if (!isset($error_message)) {
                        if ($settings['email_sending'] == 'enabled') {
                            ...
                            $emailContent = $this->generateOrderEmail($order, $customer, $courier, $orderProducts, $settings, "Order Confirmation");
        ...
        if (!empty($_POST['id'])) {
            ...
            if (!isset($error_message)) {
                if ($settings['email_sending'] == 'enabled') {
                    ...
                    $emailContent = $this->generateOrderEmail($order, $customer, $courier, $orderProducts, $settings, "Order Update");
    ...
    private function generateOrderEmail($order, $customer, $courier, $products, $settings, $title) {
        ob_start();
        ?>
        <!DOCTYPE html>
        <html>
